...
message = {
    "text": "📋 Phase 3: Plan 업데이트 완료",
    "blocks": [
        {
            "type": "header",
            "text": {
                "type": "plain_text",
                "text": "📋 Phase 3: Plan 업데이트",
                "emoji": True
            }
        },
        {
            ...
            "text": {
                "type": "mrkdwn",
                "text": "*Review Agent 리뷰 완료* ✅\n\n*작성 내용:*\n• Python 3.11+ / FastAPI 기술 스택\n• 4단계 구현 플랜 (Issue→Spec→Plan→Tasks→구현)\n• GitHub Webhook + Slack 연동\n• Constitution Check 통과"
            }
        },
        {
            "type": "section",
